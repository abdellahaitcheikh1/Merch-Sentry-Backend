...
return new class extends Migration
{
    ...
    {
        Schema::connection('mysql_Thalassa_Industriel')->create('detail_commande_clients', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('detail_commande_clients__thalassa__industriels');
    }
};
