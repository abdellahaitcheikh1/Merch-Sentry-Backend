...
return new class extends Migration
{
    ...
    {
        Schema::connection('mysql_Univers_Tracks')->create('detail_commande_clients', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('details_commande_commercials__univers__tracks');
    }
};
