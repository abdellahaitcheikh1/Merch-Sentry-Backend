...
return new class extends Migration
{
    ...
    {
        Schema::connection('mysql_second')->create('detail_commande_clients', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::connection('mysql_second')->dropIfExists('detail_commande_clients');
    }
};
