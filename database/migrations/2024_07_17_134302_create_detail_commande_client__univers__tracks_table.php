...
return new class extends Migration
{
    ...
    {
        Schema::connection('mysql_Univers_Tracks')->create('detail_commande_commercials', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('detail_commande_client__univers__tracks');
    }
};
