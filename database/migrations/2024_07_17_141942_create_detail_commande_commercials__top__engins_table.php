...
return new class extends Migration
{
    ...
    {
        Schema::connection('mysql_Top_Engins')->create('detail_commande_commercials', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('detail_commande_commercials__top__engins');
    }
};
